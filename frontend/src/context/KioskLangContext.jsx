...
const T = {
  de: {
    ...
    licensePlate: 'Kennzeichen (Fahrzeug)',
    licensePlatePlaceholder: 'z.B. HB-AB 123',
    parkingSpot: 'Parkplatz',
    parkingPlaceholder: '– Kein Parkplatz –',
    parkingOccupied: '(belegt)',
    notes: 'Hinweise',
  ...
  en: {
    ...
    licensePlate: 'License plate (vehicle)',
    licensePlatePlaceholder: 'e.g. HB-AB 123',
    parkingSpot: 'Parking spot',
    parkingPlaceholder: '– No parking spot –',
